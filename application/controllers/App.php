...
* Version     : 1.1
* Update      : 06 June 2020
* youtube     : https://www.youtube.com/@upwind2543
* Telegram    : https://t.me/kekartim
* Whatsapp    : https://wa.me/62 819-3729-6315
* Donate      : Dana (6282387311178)
*
...
class App extends CI_Controller {
  ...
  */
  ...
  private function about_tools()
  {
    ...
    $this->climate->out('  Author          : tepaks');
    ...
    $this->climate->out('                    +------------------------------------+');
    $this->climate->out("  Donate          : Ovo/Dana ({$this->green}6282387311178{$this->reset})");
    $this->climate->out('  Contact         : +------------------------------------+');
    $this->climate->out("                    * youtube ({$this->green}https://www.youtube.com/@upwind2543{$this->reset})");
    $this->climate->out("                    * Telegram ({$this->green}https://t.me/kekartim{$this->reset})");
    $this->climate->out("                    * Whatsapp ({$this->green}https://wa.me/62 819-3729-6315{$this->reset})");
    $this->climate->out('                    +------------------------------------+');
